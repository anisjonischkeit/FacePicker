    ...
    function _class(props) {
        ...
        _this.initialize = function (node) {
            ...
            if (_this.props.maxSize) {
                if (_this.props.maxSize.width !== undefined) {
                    maxSize.width = _this.props.maxSize.width;
                }
                if (_this.props.maxSize.height !== undefined) {
                    maxSize.height = _this.props.maxSize.height;
                }
            }

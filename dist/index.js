...
var _ReactWrapper = __webpack_require__(1);

var _ReactWrapper2 = _interopRequireDefault(_ReactWrapper);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _ReactWrapper2.default;
...
var _user$project$Translations$distanceBetweenEyes = function (_p0) {
	var _p1 = _p0;
	var _p3 = _p1.right;
	var _p2 = _p1.left;
	var y = _elm_lang$core$Basics$abs(_p2.y - _p3.y);
	var x = _elm_lang$core$Basics$abs(_p2.x - _p3.x);
	return _elm_lang$core$Basics$sqrt(
		Math.pow(x, 2) + Math.pow(y, 2));
};
var _user$project$Translations$radiusFromEyes = function (eyes) {
	var betweenEyes = _user$project$Translations$distanceBetweenEyes(eyes);
	return betweenEyes + (betweenEyes / 2);
};
var _user$project$Translations$scaleFactor = F2(
	function (item, container) {
		return A2(
			_elm_lang$core$Basics$min,
			_elm_lang$core$Basics$toFloat(container.width) / _elm_lang$core$Basics$toFloat(item.width),
			_elm_lang$core$Basics$toFloat(container.height) / _elm_lang$core$Basics$toFloat(item.height));
	});
var _user$project$Translations$Position = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _user$project$Translations$subtractPos = F2(
	function (a, b) {
		return A2(_user$project$Translations$Position, a.x - b.x, a.y - b.y);
	});
var _user$project$Translations$addPos = F2(
	function (a, b) {
		return A2(_user$project$Translations$Position, a.x + b.x, a.y + b.y);
	});
var _user$project$Translations$multiplyPos = F2(
	function (a, b) {
		return A2(_user$project$Translations$Position, a.x * b.x, a.y * b.y);
	});
var _user$project$Translations$dividePos = F2(
	function (a, b) {
		return A2(_user$project$Translations$Position, a.x / b.x, a.y / b.y);
	});
var _user$project$Translations$faceCentreFromEyes = function (_p4) {
	var _p5 = _p4;
	var _p7 = _p5.right;
	var _p6 = _p5.left;
	var yd = (_p6.y - _p7.y) / 2;
	var xd = (_p6.x - _p7.x) / 2;
	var yc = (_p6.y + _p7.y) / 2;
	var y3 = yc - xd;
	var xc = (_p6.x + _p7.x) / 2;
	var x3 = xc + yd;
	return A2(_user$project$Translations$Position, x3, y3);
};
var _user$project$Translations$xyFromEyes = function (eyes) {
	var centre = _user$project$Translations$faceCentreFromEyes(eyes);
	var radius = _user$project$Translations$radiusFromEyes(eyes);
	var x = centre.x - radius;
	var y = centre.y - radius;
	return centre;
};
var _user$project$Translations$Eyes = F2(
	function (a, b) {
...
var _user$project$Main$offsetPosition = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Translations$Position,
	A2(_elm_lang$core$Json_Decode$field, 'layerX', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode$field, 'layerY', _elm_lang$core$Json_Decode$float));
var _user$project$Main$offsetPositionWDefault = _user$project$Main$offsetPosition;
...
var _user$project$Main$getActualElementSize = function (model) {
	var height = function () {
		var _p0 = model.maxSize.height;
		if (_p0.ctor === 'Just') {
			return A2(_elm_lang$core$Basics$min, _p0._0, model.size.height);
		} else {
			return model.size.height;
		}
	}();
	var width = function () {
		var _p1 = model.maxSize.width;
		if (_p1.ctor === 'Just') {
			return A2(_elm_lang$core$Basics$min, _p1._0, model.size.width);
		} else {
			return model.size.width;
		}
	}();
	return A2(_elm_lang$window$Window$Size, width, height);
};
var _user$project$Main$getScaleFactor = function (model) {
	var _p2 = model.imgSize;
	if (_p2.ctor === 'Just') {
		return A2(
			_user$project$Translations$scaleFactor,
			_p2._0,
			_user$project$Main$getActualElementSize(model));
	} else {
		return 1;
	}
};
...
var _user$project$Main$createSvgClippedFaces = function (thingsToClip) {
	return A2(
		_elm_lang$svg$Svg$clipPath,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$id('clipCircles'),
			_1: {ctor: '[]'}
		},
		thingsToClip);
};
var _user$project$Main$newFaceEyes = F3(
	function (oldEyes, leftEyeShift, rightEyeShift) {
		var rightEye = A2(_user$project$Translations$addPos, oldEyes.right, rightEyeShift);
		var leftEye = A2(_user$project$Translations$addPos, oldEyes.left, leftEyeShift);
		return A2(_user$project$Translations$Eyes, leftEye, rightEye);
	});
var _user$project$Main$updateFace = F5(
	function (selection, leftEyeShift, rightEyeShift, idx, face) {
		return _elm_lang$core$Native_Utils.eq(idx, selection) ? A3(_user$project$Main$newFaceEyes, face, leftEyeShift, rightEyeShift) : face;
	});
var _user$project$Main$getNewFaces = F4(
	function (faces, selection, leftEyeShift, rightEyeShift) {
		var _p3 = selection;
		if (_p3.ctor === 'Just') {
			return A2(
				_elm_lang$core$List$indexedMap,
				A3(_user$project$Main$updateFace, _p3._0, leftEyeShift, rightEyeShift),
				faces);
		} else {
			return faces;
		}
	});
var _user$project$Main$marginScene = 0;
var _user$project$Main$newDim = _elm_lang$core$Native_Platform.incomingPort(
	'newDim',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (width) {
...
var _user$project$Main$newFaces = _elm_lang$core$Native_Platform.incomingPort(
	'newFaces',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (x0) {
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(_elm_lang$core$Json_Decode$field, 'x', _elm_lang$core$Json_Decode$float))))))));
var _user$project$Main$newState = _elm_lang$core$Native_Platform.incomingPort(
	'newState',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (x0) {
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(_elm_lang$core$Json_Decode$field, 'x', _elm_lang$core$Json_Decode$float))))))));
var _user$project$Main$newContainerSize = _elm_lang$core$Native_Platform.incomingPort(
	'newContainerSize',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (width) {
...
var _user$project$Main$facesChanged = _elm_lang$core$Native_Platform.outgoingPort(
	'facesChanged',
	function (v) {
		return [
			...
			function (v) {
				return {
					left: {x: v.left.x, y: v.left.y},
					right: {x: v.right.x, y: v.right.y}
				};
			}),
			(v._1.ctor === 'Nothing') ? null : v._1._0
		];
	});
var _user$project$Main$getDim = _elm_lang$core$Native_Platform.outgoingPort(
	'getDim',
	function (v) {
		return v;
	});
var _user$project$Main$SizeWithMaybes = F2(
	function (a, b) {
		return {width: a, height: b};
	});
var _user$project$Main$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {size: a, maxSize: b, mousePos: c, mouseState: d, imgSize: e, faceSelection: f, faces: g, imgUrl: h};
	});
var _user$project$Main$Flags = F4(
	function (a, b, c, d) {
		return {selection: a, faces: b, imgUrl: c, maxSize: d};
	});
var _user$project$Main$Face = function (a) {
	return {ctor: 'Face', _0: a};
};
var _user$project$Main$RightEye = function (a) {
	return {ctor: 'RightEye', _0: a};
};
var _user$project$Main$LeftEye = function (a) {
	return {ctor: 'LeftEye', _0: a};
};
var _user$project$Main$Up = {ctor: 'Up'};
var _user$project$Main$DownOn = function (a) {
	return {ctor: 'DownOn', _0: a};
};
		...
		switch (_p4.ctor) {
			case 'WindowSize':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							size: A2(_elm_lang$window$Window$Size, _p4._0.width - (2 * _user$project$Main$marginScene), (_p4._0.height - 100) - (2 * _user$project$Main$marginScene))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'MouseMove':
				var _p7 = _p4._1;
				var _p5 = model.mouseState;
				switch (_p5.ctor) {
					case 'DownOn':
						var updateEyes = F2(
							function (lShift, rShift) {
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											faces: A4(_user$project$Main$getNewFaces, model.faces, model.faceSelection, lShift, rShift),
											mousePos: _p7
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							});
						var scaleFactor = _user$project$Main$getScaleFactor(model);
						var shift = A3(
							_elm_lang$core$Basics$flip,
							_user$project$Translations$dividePos,
							A2(_user$project$Translations$Position, scaleFactor, scaleFactor),
							A2(_user$project$Translations$subtractPos, _p7, model.mousePos));
						var _p6 = _p5._0;
						switch (_p6.ctor) {
							case 'Face':
								return A2(updateEyes, shift, shift);
							case 'LeftEye':
								return A2(
									updateEyes,
									shift,
									A2(_user$project$Translations$Position, 0, 0));
							default:
								return A2(
									updateEyes,
									A2(_user$project$Translations$Position, 0, 0),
			...
			case 'UpdateDim':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							imgSize: _elm_lang$core$Maybe$Just(_p4._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateFacesFromPort':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{faces: _p4._0._0, faceSelection: _p4._0._1}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateStateFromPort':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							faces: _p4._0._0,
							faceSelection: _p4._0._1,
							imgUrl: _p4._0._2,
							imgSize: _elm_lang$core$Maybe$Just(_p4._0._3)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'MouseDown':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{mouseState: _user$project$Main$Down, faceSelection: _elm_lang$core$Maybe$Nothing}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'MouseDownOnFace':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							faceSelection: _elm_lang$core$Maybe$Just(_p4._0),
							mouseState: _user$project$Main$DownOn(
								_user$project$Main$Face(_p4._1))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'MouseMoveOnFace':
				var _p8 = _p4._1;
				var absolutePos = A2(_user$project$Translations$addPos, _p4._0, _p8);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							faceSelection: _elm_lang$core$Maybe$Just(_p4._0),
							mouseState: _user$project$Main$DownOn(
								_user$project$Main$LeftEye(_p4._1))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'MouseMoveOnLeftEye':
				var _p9 = _p4._1;
				var absolutePos = A2(_user$project$Translations$addPos, _p4._0, _p9);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							faceSelection: _elm_lang$core$Maybe$Just(_p4._0),
							mouseState: _user$project$Main$DownOn(
								_user$project$Main$RightEye(_p4._1))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'MouseMoveOnRightEye':
				var _p10 = _p4._1;
				var absolutePos = A2(_user$project$Translations$addPos, _p4._0, _p10);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'MouseUp':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{mouseState: _user$project$Main$Up}),
					_1: _user$project$Main$facesChanged(
						{ctor: '_Tuple2', _0: model.faces, _1: model.faceSelection})
				};
			case 'AddFace':
				var newFace = A2(
					_user$project$Translations$Eyes,
					A2(
						_user$project$Translations$Position,
						(_elm_lang$core$Basics$toFloat(
							_elm_lang$core$List$length(model.faces)) * 70) + 75,
						50),
					A2(
						_user$project$Translations$Position,
						_elm_lang$core$Basics$toFloat(
							_elm_lang$core$List$length(model.faces) * 70) + 100,
						50));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			default:
				var _p11 = model.faceSelection;
				if (_p11.ctor === 'Just') {
					var deleteAtIndex = F2(
						function (i, xs) {
							return A2(
								_elm_lang$core$Basics_ops['++'],
					...
					var newFaces = A2(deleteAtIndex, _p11._0, model.faces);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{faces: newFaces, faceSelection: _elm_lang$core$Maybe$Nothing}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
...
var _user$project$Main$DeleteCurrentFace = {ctor: 'DeleteCurrentFace'};
var _user$project$Main$AddFace = {ctor: 'AddFace'};
var _user$project$Main$UpdateFacesFromPort = function (a) {
	return {ctor: 'UpdateFacesFromPort', _0: a};
};
var _user$project$Main$UpdateStateFromPort = function (a) {
	return {ctor: 'UpdateStateFromPort', _0: a};
};
var _user$project$Main$UpdateMaxSize = function (a) {
	return {ctor: 'UpdateMaxSize', _0: a};
};
var _user$project$Main$UpdateDim = function (a) {
	return {ctor: 'UpdateDim', _0: a};
};
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Main$newContainerSize(_user$project$Main$UpdateMaxSize),
			_1: {
				ctor: '::',
				_0: _user$project$Main$newDim(_user$project$Main$UpdateDim),
				_1: {
					ctor: '::',
					_0: _user$project$Main$newFaces(_user$project$Main$UpdateFacesFromPort),
					_1: {
						ctor: '::',
						_0: _user$project$Main$newState(_user$project$Main$UpdateStateFromPort),
						_1: {
							ctor: '::',
...
var _user$project$Main$MouseMoveOnRightEye = F2(
	function (a, b) {
		return {ctor: 'MouseMoveOnRightEye', _0: a, _1: b};
	});
var _user$project$Main$MouseDownOnRightEye = F2(
	function (a, b) {
		return {ctor: 'MouseDownOnRightEye', _0: a, _1: b};
	});
var _user$project$Main$MouseMoveOnLeftEye = F2(
	function (a, b) {
		return {ctor: 'MouseMoveOnLeftEye', _0: a, _1: b};
	});
var _user$project$Main$MouseDownOnLeftEye = F2(
	function (a, b) {
		return {ctor: 'MouseDownOnLeftEye', _0: a, _1: b};
	});
var _user$project$Main$MouseMoveOnFace = F2(
	function (a, b) {
		return {ctor: 'MouseMoveOnFace', _0: a, _1: b};
	});
var _user$project$Main$MouseDownOnFace = F2(
	function (a, b) {
		return {ctor: 'MouseDownOnFace', _0: a, _1: b};
	});
var _user$project$Main$createSvgFace = F5(
	function (scaleFactor, captureEvents, isSelected, idx, realEyes) {
		var baseStyle = 'stroke-width:2;fill:#044B94;fill-opacity:0;';
		var styleWithEventControl = captureEvents ? A2(_elm_lang$core$Basics_ops['++'], baseStyle, 'pointer-events:auto;') : A2(_elm_lang$core$Basics_ops['++'], baseStyle, 'pointer-events:none;');
		var fullStyle = isSelected ? A2(_elm_lang$core$Basics_ops['++'], styleWithEventControl, 'stroke:#7fd13b;') : A2(_elm_lang$core$Basics_ops['++'], styleWithEventControl, 'stroke:#000;');
		var scale = A2(
			_elm_lang$core$Basics$flip,
			_user$project$Translations$multiplyPos,
			A2(_user$project$Translations$Position, scaleFactor, scaleFactor));
		var eyes = {
			left: scale(realEyes.left),
			right: scale(realEyes.right)
		};
		var screenFaceCentre = _user$project$Translations$faceCentreFromEyes(eyes);
		var radius = _user$project$Translations$radiusFromEyes(eyes);
		var faceOffset = A2(
			_user$project$Translations$subtractPos,
			screenFaceCentre,
			A2(_user$project$Translations$Position, radius, radius));
		var leftEyeOffset = A2(
			_user$project$Translations$subtractPos,
			eyes.left,
			A2(_user$project$Translations$Position, 8, 8));
		var rightEyeOffset = A2(
			_user$project$Translations$subtractPos,
			eyes.right,
			A2(_user$project$Translations$Position, 8, 8));
		return {
			...
			_0: A2(
				_elm_lang$svg$Svg$circle,
				{
					...
					_0: _elm_lang$svg$Svg_Attributes$cx(
						_elm_lang$core$Basics$toString(screenFaceCentre.x)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$cy(
							_elm_lang$core$Basics$toString(screenFaceCentre.y)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$r(
								_elm_lang$core$Basics$toString(
									_user$project$Translations$radiusFromEyes(eyes))),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$style(fullStyle),
								_1: {
									ctor: '::',
									_0: A3(
										...
										A2(
											_elm_lang$core$Json_Decode$map,
											_user$project$Main$MouseMoveOnFace(faceOffset),
											_user$project$Main$offsetPosition)),
									_1: {
										ctor: '::',
										_0: A3(
											_elm_lang$virtual_dom$VirtualDom$onWithOptions,
											...
											A2(
												_elm_lang$core$Json_Decode$map,
												_user$project$Main$MouseDownOnFace(idx),
												_user$project$Main$offsetPosition)),
										_1: {ctor: '[]'}
									}
								}
			...
			_1: {
				...
				_0: A2(
					_elm_lang$svg$Svg$circle,
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$cx(
							_elm_lang$core$Basics$toString(eyes.left.x)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$cy(
								_elm_lang$core$Basics$toString(eyes.left.y)),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$r('8px'),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$style(fullStyle),
									_1: {
										...
										_0: A3(
											...
											A2(
												_elm_lang$core$Json_Decode$map,
												_user$project$Main$MouseMoveOnLeftEye(leftEyeOffset),
												_user$project$Main$offsetPosition)),
										_1: {
											ctor: '::',
											_0: A3(
												...
												A2(
													_elm_lang$core$Json_Decode$map,
													_user$project$Main$MouseDownOnLeftEye(idx),
													_user$project$Main$offsetPosition)),
											_1: {ctor: '[]'}
										}
									}
				...
				_1: {
					...
					_0: A2(
						_elm_lang$svg$Svg$circle,
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$cx(
								_elm_lang$core$Basics$toString(eyes.right.x)),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$cy(
									_elm_lang$core$Basics$toString(eyes.right.y)),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$r('8px'),
									_1: {
										...
										_1: {
											...
											_0: A3(
												...
												A2(
													_elm_lang$core$Json_Decode$map,
													_user$project$Main$MouseMoveOnRightEye(rightEyeOffset),
													_user$project$Main$offsetPosition)),
											_1: {
												ctor: '::',
												_0: A3(
													...
													A2(
														_elm_lang$core$Json_Decode$map,
														_user$project$Main$MouseDownOnRightEye(idx),
														_user$project$Main$offsetPosition)),
												_1: {ctor: '[]'}
											}
										}
...
var _user$project$Main$createSvgFaces = function (model) {
	var attachScaleFactor = _user$project$Main$createSvgFace(
		_user$project$Main$getScaleFactor(model));
	var attachCaptureEvents = function () {
		var _p12 = model.mouseState;
		if (_p12.ctor === 'DownOn') {
			return attachScaleFactor(false);
		} else {
			return attachScaleFactor(true);
		}
	}();
	var attachIsSelected = function (idx) {
		var _p13 = model.faceSelection;
		if (_p13.ctor === 'Just') {
			return A2(
				attachCaptureEvents,
				_elm_lang$core$Native_Utils.eq(idx, _p13._0),
				idx);
		} else {
			return A2(attachCaptureEvents, false, idx);
		}
	};
	var listOfLists = A2(_elm_lang$core$List$indexedMap, attachIsSelected, model.faces);
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (x, y) {
...
var _user$project$Main$MouseDown = {ctor: 'MouseDown'};
var _user$project$Main$MouseMove = F2(
	function (a, b) {
		return {ctor: 'MouseMove', _0: a, _1: b};
	});
var _user$project$Main$bgImg = F2(
	function (imgUrl, imgSize) {
		return A2(
			_elm_lang$svg$Svg$image,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$style('-webkit-user-select: none; -khtml-user-select: none; -moz-user-select: none; -o-user-select: none; user-select: none;-ms-user-drag:none; -moz-user-drag:none; user-drag:none; -webkit-user-drag:none;opacity:0.6;'),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$width(
								_elm_lang$core$Basics$toString(imgSize.width)),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$height(
									_elm_lang$core$Basics$toString(imgSize.height)),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$xlinkHref(imgUrl),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Events$onMouseDown(_user$project$Main$MouseDown),
										_1: {
											ctor: '::',
											_0: A3(
												_elm_lang$virtual_dom$VirtualDom$onWithOptions,
												...
												A2(
													_elm_lang$core$Json_Decode$map,
													_user$project$Main$MouseMove(
														A2(_user$project$Translations$Position, 0, 0)),
													_user$project$Main$offsetPositionWDefault)),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$Main$clippedBgImg = F2(
	function (imgUrl, imgSize) {
		return A2(
			_elm_lang$svg$Svg$image,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$style('-webkit-user-select: none; -khtml-user-select: none; -moz-user-select: none; -o-user-select: none; user-select: none;-ms-user-drag:none; -moz-user-drag:none; user-drag:none; -webkit-user-drag:none;'),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$width(
								_elm_lang$core$Basics$toString(imgSize.width)),
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$clipPath('url(#clipCircles)'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$xlinkHref(imgUrl),
										_1: {
...
var _user$project$Main$scene = function (model) {
	var _p14 = model.imgSize;
	if (_p14.ctor === 'Just') {
		var _p15 = _p14._0;
		var svgFaces = _user$project$Main$createSvgFaces(model);
		var scale = _user$project$Main$getScaleFactor(model);
		var size = {
			width: _elm_lang$core$Basics$round(
				_elm_lang$core$Basics$toFloat(_p15.width) * scale),
			height: _elm_lang$core$Basics$round(
				_elm_lang$core$Basics$toFloat(_p15.height) * scale)
		};
		return A2(
					...
					_1: {
						...
						_0: _elm_lang$svg$Svg_Attributes$style(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'margin-left:',
								_user$project$Main$px(_user$project$Main$marginScene))),
						_1: {ctor: '[]'}
					}
				}
			},
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					...
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$Main$bgImg,
							model.imgUrl,
							{height: size.height, width: size.width}),
						_1: {
							ctor: '::',
							_0: A2(
								_user$project$Main$clippedBgImg,
								model.imgUrl,
								{height: size.height, width: size.width}),
							_1: {
								ctor: '::',
								_0: _user$project$Main$createSvgClippedFaces(svgFaces),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$scene(model),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$AddFace),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('add face'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$DeleteCurrentFace),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('delete face'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$init = function (_p16) {
	var _p17 = _p16;
	var _p18 = _p17.imgUrl;
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{
			size: A2(_elm_lang$window$Window$Size, 600, 600),
			maxSize: _p17.maxSize,
			mousePos: A2(_user$project$Translations$Position, 0, 0),
			mouseState: _user$project$Main$Up,
			faceSelection: _p17.selection,
			imgSize: _elm_lang$core$Maybe$Nothing,
			faces: _p17.faces,
			imgUrl: _p18
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$getDim(_p18),
				_1: {ctor: '[]'}
			}
		});
};
	...
	A2(
		...
		function (faces) {
			return A2(
					...
					return A2(
						...
						function (maxSize) {
							return A2(
								...
								function (selection) {
									return _elm_lang$core$Json_Decode$succeed(
										{faces: faces, imgUrl: imgUrl, maxSize: maxSize, selection: selection});
								},
								A2(
									_elm_lang$core$Json_Decode$field,
									'selection',
				...
				A2(_elm_lang$core$Json_Decode$field, 'imgUrl', _elm_lang$core$Json_Decode$string));
		},
		A2(
			_elm_lang$core$Json_Decode$field,
			'faces',
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"MouseUp":["Mouse.Position"],"UpdateMaxSize":["Main.SizeWithMaybes"],"MouseDownOnLeftEye":["Int","Translations.Position"],"MouseMoveOnLeftEye":["Translations.Position","Translations.Position"],"MouseDown":[],"MouseDownOnRightEye":["Int","Translations.Position"],"MouseDownOnFace":["Int","Translations.Position"],"UpdateStateFromPort":["( Main.Faces, Maybe.Maybe Int, String, Window.Size )"],"WindowSize":["Window.Size"],"UpdateFacesFromPort":["( Main.Faces, Maybe.Maybe Int )"],"MouseMoveOnRightEye":["Translations.Position","Translations.Position"],"MouseMove":["Translations.Position","Translations.Position"],"MouseMoveOnFace":["Translations.Position","Translations.Position"],"AddFace":[],"UpdateDim":["Window.Size"],"DeleteCurrentFace":[]}}},"aliases":{"Translations.Eyes":{"args":[],"type":"{ left : Translations.Position, right : Translations.Position }"},"Main.Faces":{"args":[],"type":"List Translations.Eyes"},"Mouse.Position":{"args":[],"type":"{ x : Int, y : Int }"},"Window.Size":{"args":[],"type":"{ width : Int, height : Int }"},"Translations.Position":{"args":[],"type":"{ x : Float, y : Float }"},"Main.SizeWithMaybes":{"args":[],"type":"{ width : Maybe.Maybe Int, height : Maybe.Maybe Int }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
